...
const blogPosts = [
    {
        ...
        content: `
            ...
            <p>In the world of e-commerce, scalability isn't just a feature—it's a survival requirement. This project reflection walks through the full lifecycle of my <strong>Threads Fashion</strong> e-commerce API, built with Spring Boot and MongoDB, from initial sketches to deployment on Render and Vercel.</p>
            ...
            <ul>
                ...
                <li><strong>Render Hosting:</strong> Deployed the Spring Boot API securely on Render with automated build pipelines.</li>
                <li><strong>Vercel Edge:</strong> Hosted the frontend on Vercel for optimized global content delivery and performance.</li>
