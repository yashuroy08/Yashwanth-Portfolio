        ...
        <div className="flex flex-col md:flex-row items-center justify-between mb-8">
          ...
          >
            ...
            <div className="flex items-center gap-4">
              ...
              <a href="https://www.linkedin.com/in/yashwanth-patam/" target="_blank" rel="noopener noreferrer" className="text-muted hover:text-red transition-colors" aria-label="LinkedIn">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="square" strokeLinejoin="miter">
