...
const Contact = () => {
  ...
  const copyEmail = () => {
    navigator.clipboard.writeText('royyashwanth52@gmail.com');
    setCopied(true);
            ...
            >
              ...
              >
                ...
                <div>
                  ...
                  <div className="flex items-center gap-3">
                    <a href="mailto:royyashwanth52@gmail.com" className="text-muted hover:text-light transition-colors break-all">
              ...
              >
                ...
                <div>
                  ...
                  <a href="tel:+917670971930" className="text-muted hover:text-light transition-colors">
                    +91 7670971930
                  </a>
                </div>
              </motion.div>
