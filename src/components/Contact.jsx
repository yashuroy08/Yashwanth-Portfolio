...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const templateParams = {
      ...
      to_email: 'royyashwanth52@gmail.com',
      date_time: formattedDate,
      user_login: 'yashwanthpatam'
    };
            ...
            >
              ...
              >
                ...
                <div>
                  ...
                  <a href="royyashwanth52@gmail.com" className="text-muted hover:text-light transition-colors">
                    royyashwanth52@gmail.com
                  </a>
                </div>
              </motion.div>
              ...
              >
                ...
                <div>
                  ...
                  <div className="flex gap-3 mt-2">
                    {/* GitHub */}
                    <a href="https://github.com/yashuroy08" target="_blank" rel="noopener noreferrer" className="hover:opacity-80 transition-opacity">
                    ...
                    {/* LinkedIn */}
                    <a href="https://www.linkedin.com/in/yashwanth-patam-506044324/" target="_blank" rel="noopener noreferrer" className="hover:opacity-80 transition-opacity">
                    ...
                    {/* Twitter */}
                    {/* <a href="https://x.com/kaushal_dev_" target="_blank" rel="noopener noreferrer" className="hover:opacity-80 transition-opacity">
