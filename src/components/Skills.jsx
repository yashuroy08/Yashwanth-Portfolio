      ...
      <div className="container-custom relative z-10" ref={ref}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 auto-rows-[minmax(180px,auto)] text-accent font-mono relative mt-12">
          ...
          >
            ...
            <div className="flex flex-col items-start w-full">
              <div className="flex flex-col md:flex-row md:items-end gap-2 md:gap-4 w-full">
                <ScrambleText text="JAVA" className="text-3xl sm:text-4xl md:text-6xl font-black uppercase tracking-tighter leading-none" style={{ color: 'var(--color-red)' }} />
              ...
              <div className="flex flex-col md:flex-row md:items-end gap-2 md:gap-4 mt-4 w-full">
                <ScrambleText text="SPRING BOOT" className="text-3xl sm:text-4xl md:text-6xl font-black uppercase tracking-tighter leading-none" style={{ color: 'var(--color-accent)' }} />
          ...
          <motion.div
            ...
            variants={bootUpVariants}
            viewport={{ once: true, amount: 0.2 }}
            className="md:col-span-2 md:row-span-1 border-4 bg-primary p-6 relative flex flex-col sm:flex-row justify-between sm:items-center items-start gap-4 sm:gap-0"
            style={{
              borderColor: 'var(--color-accent)',
          ...
          >
            ...
            <div className="flex gap-6 mt-8 sm:mt-10 self-start">
              {/* MongoDB Logo */}
            ...
            <div className="flex flex-col gap-4 sm:items-end w-full sm:w-auto">
              <div className="flex flex-col items-start sm:items-end gap-1">
                <ScrambleText text="MONGODB" className="text-2xl sm:text-3xl md:text-4xl font-bold uppercase tracking-widest leading-none" style={{ color: 'var(--color-accent)' }} />
                <ProficiencyBadge level={4} label="NOSQL" />
              </div>
              <div className="flex flex-col items-start sm:items-end gap-1">
                <ScrambleText text="MYSQL" className="text-2xl sm:text-3xl md:text-4xl font-bold uppercase tracking-widest leading-none" style={{ color: 'var(--color-light)' }} />
          ...
          >
            ...
            <div className="flex flex-col md:flex-row items-start md:items-center justify-between w-full relative z-10 mt-8 md:mt-0">
              ...
              <div className="flex flex-col sm:flex-row gap-4 md:gap-8 items-start md:items-center text-left md:text-right border-l-0 md:border-l-4 pl-0 md:pl-8 border-transparent md:border-red">
                <div className="flex flex-col">
                  <ScrambleText text="REST APIS" className="text-2xl sm:text-3xl md:text-4xl font-black uppercase tracking-widest text-light leading-none" />
                  <ProficiencyBadge level={5} label="APIS" />
                </div>
                <div className="flex flex-col mt-4 sm:mt-0">
                  <ScrambleText text="SPRING SECURITY" className="text-lg sm:text-2xl md:text-3xl font-black uppercase tracking-widest text-red leading-none" />
